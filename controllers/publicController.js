...
const getPosts = async (req,res) => {
    try {
        const [headline, lastNews, bitcoin, otherNews] = await Promise.all([
            queries(`SELECT post_uid, status, fullName, title, slug, categories, tags, created_date, image_url 
        ...
        console.log(headline, lastNews, bitcoin, otherNews)
